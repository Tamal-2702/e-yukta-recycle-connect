...
const SignUpForm: React.FC<SignUpFormProps> = ({ userRole = '' }) => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (error.code === "auth/unauthorized-domain") {
        ...
        errorMessage = "Multiple popup requests were triggered. Only one popup can be open at a time.";
      } else if (error.code === "auth/popup-blocked") {
        errorMessage = "The popup was blocked by the browser. Please allow popups for this site.";
      }
